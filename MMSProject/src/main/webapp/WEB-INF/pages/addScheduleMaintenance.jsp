<%-- Document : addScheduleMaintenance Created on : Aug 13, 2024, 1:38:59 PM
Author : Do Gia Huy --%> <%@page contentType="text/html" pageEncoding="UTF-8"%>
...
<div class="col-10 container-fluid">
  ...
  >
    ...
    <div class="mb-3 mt-3">
      <label for="maintenanceTypeId" class="form-label"
        >Maintenance type:
      </label>
      <form:select
        class="form-select"
    ...
    <form:hidden path="id" />
    <button
      class="mb-3 mt-3 text-center form-control btn btn-success"
      type="submit"
    >
      <c:choose>
